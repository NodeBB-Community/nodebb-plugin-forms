					...
					'radiogroup': {
						...
						template:	'<label data-text="label" class="control-label" tabindex="0">{label}</label>\
									...
									<div class="radio" data-object="options">\
										<input data-checked="default" data-value="value" class="pfa-input-option" type="radio" value="{options.value}" checked="{options.default}" name="{name}"/>\
					...
					'checkboxes': {
						...
						template:	'<label data-text="label" class="control-label" tabindex="0">{label}</label>\
									...
									<div class="checkbox" data-object="options">\
										<input data-checked="default" data-value="value" class="pfa-input-option" type="checkbox" value="{options.value}" checked="{options.default}" name="{name}"/>\
										<label data-text="label" class="control-label pfa-input-option-label" tabindex="0">{options.label}</label>\
									</div>\
									<!-- END options -->',
						newdata: {options: [{value: '1', label: 'Option 1'},{value: '2', label: 'Option 2'},{value: '3', label: 'Option 3'}]}
			...
			$pluginForms.on('click', '.pfa-btn-edit-input', function (e) {
				...
				$formGroups.each(function(i, fg) {
					var $fg = $(fg),
						...
						label = $fg.find('label[data-text]').text(),
				...
				var type = $openInput.attr('type') || 'text',
					...
					$label = $formGroup.find('label[data-text]').first(),
					...
					$('#pfa-forms-list').children().each(function(){
						...
						$(this).find('.pfa-input-panel').each(function(){
							...
							switch (type) {
								...
								case 'address':
								case 'info':
									input['default'] = $inputPanel.find(".pfa-input").val();
									break;
								case 'select':
								case 'selectmultiple':
								case 'select2':
									var $options = $inputPanel.find("option");
