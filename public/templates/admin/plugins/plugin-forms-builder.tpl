    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="panel panel-primary" id="pfa-inputs-panel">
                ...
                <div class="panel-body">
                    <div id="pfa-inputs-panel-standard"><span>Standard Inputs</span><hr>
                      <!-- BEGIN formElementsStandard -->
                      <div class="btn-draggable pfa-pill-info" type="@key"><span class="text-center">@value</span></div>
                      <!-- END -->
                    </div>
                    <div id="pfa-inputs-panel-advanced"><span>Advanced Inputs</span><hr>
                      <!-- BEGIN formElementsAdvanced -->
                      <div class="btn-draggable pfa-pill-info" type="@key"><span class="text-center">@value</span></div>
                      <!-- END -->
                    </div>
                    <div id="pfa-inputs-panel-decor"><span>Form Decorations</span><hr>
                      <!-- BEGIN formElementsDecor -->
                      <div class="btn-draggable pfa-pill-danger" type="@key"><span class="text-center">@value</span></div>
                      <!-- END -->
                    </div>
                    <div id="pfa-inputs-panel-phase"><span>Form Phases</span><hr>
                      <!-- BEGIN formElementsPhase -->
                      <div class="btn-draggable pfa-pill-warning" type="@key"><span class="text-center">@value</span></div>
                      <!-- END -->
                    </div>
                </div>
            </div>
